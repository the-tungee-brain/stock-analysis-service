    ...
    if strategy in WHEEL_LIKE:
        ...
        lines.extend(
            [
                ...
                "- Walk **Portfolio cash map (precomputed)** and **Holding-by-holding review (precomputed)** in DIVERSIFICATION SUMMARY.",
        ...
        lines.extend(
            [
                ...
                "- Walk **Portfolio cash map (precomputed)** and **Holding-by-holding review (precomputed)** before deploy steps.",

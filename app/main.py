...
from app.api.get_position_guidance_route import router as get_position_guidance_router
from app.api.get_trade_decision_route import router as get_trade_decision_route
from app.api.get_trading_bias_route import router as get_trading_bias_route
from app.api.get_intraday_trading_bias_route import (
    router as get_intraday_trading_bias_route,
)
from app.api.day_trade_backtest_route import router as day_trade_backtest_router
from app.api.get_trader_playbook_route import router as get_trader_playbook_route
from app.api.trade_replay_route import router as trade_replay_router
...
from app.api.get_portfolio_optimization_route import (
    router as get_portfolio_optimization_router,
)
...
from app.api.momentum_breakout_check_route import (
    router as momentum_breakout_check_router,
)
from app.api.custom_trade_plan_route import router as custom_trade_plan_router
...
protected_api.include_router(get_portfolio_optimization_router)
...
protected_api.include_router(momentum_breakout_check_router)
protected_api.include_router(custom_trade_plan_router)
...
protected_api.include_router(day_trade_backtest_router)
protected_api.include_router(get_trader_playbook_route)
protected_api.include_router(trade_replay_router)
